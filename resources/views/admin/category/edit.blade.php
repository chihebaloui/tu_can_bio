                        ...
                        <div class="mb-3">
                            ...
                            <div id="image" class="dropzone dz-clickable">
                                <div class="dz-message needsclick">
                                    <br>Drop files here or click to uload.
                                     <br><br>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <select name="showHome" id="showHome" class="form-control">
                               <option value="1"  {{($category->showHome=='Yes')?'selected':''}}>Yes</option>
                               <option value="0" {{($category->showHome=='No')?'selected':''}}>No</option>
...
@section('customJs')
   <script>
    ...
    const dropzone = $("#image").dropzone({init: function(){
