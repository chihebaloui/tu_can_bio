                    ...
                    <div class="card-body">
                        ...
                        @foreach($brands as $brand)
                            <div class="form-check mb-2">
                                <input  type="checkbox"  class="form-check-input brand-label" name="brand[]" value="{{ $brand->id }}" id="brand-{{ $brand->id }}" {{ in_array($brand->id, $brandsArray) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex align-items-center justify-content-end mb-4">
                            <div class="ml-2">
                                <select name="sort" id="sort" class="from-control">
                                    ...
                                    <option value="price_desc"  {{($sort =='latest') ? 'price_desc' : ''}}>Price High</option>
                                    <option value="price_asc"  {{($sort =='latest') ? 'price_asc' : ''}}>Price Low</option>
                                    </select>                                    
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card product-card">
                            <div class="product-image position-relative">
                                <a href="{{route("front.product",$product->slug)}}" class="product-img" class="product-img">
