                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <p class="product-rating-error text-danger text-danger"></p>
                                    </div>
                                    <div class="form-group mb-3">
                ...
                <div class="card product-card">
                    ...
                    <div class="card-body text-center mt-3">
                        ...
                        <div class="price mt-2">
                            <span class="h5"><strong>{{$relProduct->price}}DT</strong></span>
                            @if($relProduct->compare_price>0)
                            <span class="h6 text-underline"><del>{{$relProduct->compare_price}}DT</del></span>
                            @endif
                        </div>
                    </div>                        
                </div> 
