            ...
            <div class="col-md-4">
                ...
                <div class="card cart-summery">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between pb-2">
                            ...
                            <div class="h6">{{$item->price*$item->qty}} DT</div>
                        </div>
                        @endforeach
                        ...
                        <div class="d-flex justify-content-between summery-end">
                            ...
                            <div class="h6"><strong>{{Cart::subtotal()}} DT</strong></div>
                        </div>
                        <div class="d-flex justify-content-between summery-end">
                            <div class="h6"><strong>Discount</strong></div>
                            <div class="h6"><strong id="discount_value">{{$discount}} DT</strong></div>
                        </div>
                        <div class="d-flex justify-content-between mt-2">
                            <div class="h6"><strong>Shipping</strong></div>
                            <div class="h6" id="shippingAmount"><strong>{{number_format($totalShippingCharge,2)}} DT</strong></div>
                        </div>
                        <div class="d-flex justify-content-between mt-2 summery-end">
                            <div class="h5" ><strong>Total</strong></div>
                            <div class="h5" id="grandTotal"><strong>{{number_format($grandTotal,2)}} DT</strong></div>
                        </div>                            
                    </div>
                </div>   
                <div class="input-group apply-coupan mt-4">
                    <input type="text" placeholder="Coupan Code" class="form-control" id="discount_code"  name="discount_code">

                    <button class="btn btn-dark" type="button" id="apply-discount">Apply Coupan</button>
                ...
                <div class="card payment-form ">                  
                    ...
                    <div class="form-check">
                        <input checked type="radio" name="payment_method" id="payment_method_one" value="cod" class="form-check-input">
                        <label for="payment_method_one" class="form-ckeck-label">COD</label>
                    </div>

                    <div class="form-check">
                        <input type="radio" name="payment_method" id="payment_method_two" value="stripe" class="form-check-input">
                        <label for="payment_method_two" class="form-ckeck-label">Stripe</label>
                    </div>
                    <br>
                ...
                <!-- CREDIT CARD FORM ENDS HERE src="https://js.stripe.com/v3/"-->
        ...
        $.ajax({
            ...
            success: function(response){
                if( response.status == true ){
                    $("#shippingAmount").html(response.shippingCharge+'DT');
                    $("#grandTotal").html(response.grandTotal+'DT');
                }
        ...
        $.ajax({
            ...
            success: function(response){
                if( response.status == true ){
                    $("#shippingAmount").html(response.shippingCharge+'DT');
                    $("#grandTotal").html(response.grandTotal+'DT');
                    $('#discount_value').html(response.discount+'DT');
